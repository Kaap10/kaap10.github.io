...
export function IconFlame({ size = 16, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" stroke="none" className={className}>
      <path d="M12 23c-4.97 0-9-4.03-9-9 0-4.03 2.92-7.85 6.27-10.51.52-.41 1.28-.15 1.45.5.34 1.34 1.05 3.01 2.28 3.01 1.35 0 1.76-1.57 2.06-2.9.15-.65.91-.93 1.44-.51C19.26 6.37 21 9.94 21 14c0 4.97-4.03 9-9 9zm0-4c2.21 0 4-1.79 4-4 0-1.87-1.12-3.83-2.61-4.88-.42-.3-.99-.07-1.09.43-.17.85-.72 2.45-1.8 2.45-1.17 0-1.5-1.5-1.7-2.33-.12-.49-.68-.71-1.08-.42C6.72 10.98 6 12.63 6 14c0 2.21 1.79 4 4 4z" />
    </svg>
  );
}
