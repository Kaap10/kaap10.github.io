...
const PROJECTS = [
  ...
  // 3. AuraNow (AI)
  {
    ...
    details: {
      ...
      fullHighlights: [
        ...
        'AI Content Strategist & Chat: Context-aware chatbot and AI-generated content suggestions powered by Large Language Models',
        'Async Pipeline: FastAPI, Motor async MongoDB, and Redis background queues for high-throughput comment ingestion',
      ],
  ...
  // 8. Model Router (Agents)
  {
    ...
    metrics: 'Cost Optimization · Up to 40–70% in benchmark workloads',
    recruiterHighlight:
    ...
    details: {
      ...
      metricsDetail: 'Cost optimization: Up to 40–70% savings in benchmark workloads · Sub-10ms routing overhead · Multi-provider failover',
    },
  },
];
