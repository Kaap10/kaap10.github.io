...
export default function PalinodePage() {
  return (
    <Layout
      title="palinode"
      description="Palinode open-source contributions by Vardhman Gupta."
    >
      <main className={styles.pageContainer}>
        <div className={styles.contentWrapper}>
          <nav className={styles.breadcrumbNav}>
            ...
            <span>/</span>
            <span className={styles.breadcrumbCurrent}>palinode</span>
          </nav>
